...
var BR2JSX = function (_React$Component) {
  ...
  function BR2JSX() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = BR2JSX.__proto__ || Object.getPrototypeOf(BR2JSX)).call.apply(_ref, [this].concat(args))), _this), _this.parseText = function (text) {
      var pattern = /(<br\s*\/?>)/ig;
      var stringArr = text.split(pattern);
      return stringArr.map(function (item, i) {
        if (pattern.test(item)) {
          item = _react2.default.createElement('br', { key: i });
        }
        return item;
      });
